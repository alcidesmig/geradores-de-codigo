...
public class GerarClasseGUI1 {
    ...
    public GerarClasseGUI1(String caminho, String formatoDate, Boolean temImg) {
        ...
        codigo.add("");
        codigo.add("    Controle" + nomeClasseUp + " controle = new Controle" + nomeClasseUp + "();");
        ...
        codigo.add("        dados = manipulaArquivo.abrirArquivo(\"dados" + nomeClasseUp + ".txt\");");
        ...
        for (int i = 0; i < descricaoEntidade.size(); i++) {
            ...
            if (i == descricaoEntidade.size() - 1) {
                ...
                } else if (aux[1].equals("String") || aux[1].equals("Dependente")) {
                    codigo.add("            aux[" + i + "]));");
...
//        }
        ...
        codigo.add("                        controle.alterar(" + nomeClasse + "Original" + ", " + nomeClasse + ");");
        ...
        codigo.add("            @Override");
        codigo.add("            public void actionPerformed(ActionEvent e) {");
        codigo.add("                new " + nomeClasseUp + "GUIListagem(controle.retornaLista(), 0, 0);");
        codigo.add("            }");
        codigo.add("        }");
        codigo.add("        );");
        codigo.add("");
        ...
        codigo.add("                }");
        codigo.add("                manipulaArquivo.salvarArquivo(\"dados" + nomeClasseUp + ".txt\", dados);");
        codigo.add("                dispose();");
        codigo.add("            }");
        codigo.add("        }");
        codigo.add("        );");
