 ...
 * @author user
 */
public class GerarDAOEsp_atributosIncompletos {

    public void gerar(String nomeClasse, List<String> atributos) {

        String chave = atributos.get(0).split(";")[0];
        String chaveMaiuscula = String.valueOf(chave.charAt(0)).toUpperCase() + chave.substring(1);
        String chave2 = atributos.get(1).split(";")[0];
        ...
        String x = "package DAOs;\n"
                ...
                + "    }\n"
                + "\n"
                + "    public List<" + nomeClasse + "> listBy" + chaveMaiuscula + "(" + atributos.get(0).split(";")[1] + " " + chave + ") {\n"
                + "        return em.createQuery(\"SELECT e FROM " + nomeClasse + " e WHERE e." + chave + " = :" + chave + "\").setParameter(\"" + chave + "\", " + chave + ").getResultList();\n"
                + "    }\n"
                + "\n"
                + "    public List<" + nomeClasse + "> listBy" + chave2Maiuscula + "(" + atributos.get(1).split(";")[1] + " " + chave2 + ") {\n"
    ...
    public static String gerarListagem(List<String> atributos) {
        List<String> lista = atributos;
        String a = "";
